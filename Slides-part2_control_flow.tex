...
\begin{frame}{CFG Linearization Overivew}

\begin{minipage}[t]{0.45\linewidth}

\begin{itemize}
    \item Flattens CFG: all blocks are executed
    \item Masks and select take care of the data flow
    \item Linearization Process
    \begin{itemize}
        \item Order blocks
