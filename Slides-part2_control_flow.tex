...
\center{\includegraphics[scale=0.45]{images/linearization-overview.pdf}}
...
\begin{itemize}
    \item Topological sort of the graph
    \begin{itemize}
        \item Result is a list of graph nodes
        \item Loop nodes expand to sub-lists
        \item Can be seen as a tree
    \end{itemize}
...
\begin{itemize}
    \item Visit each block in the list
    \item Rewrite their branch target
\end{itemize}

\begin{itemize}
    \item Blocks other than the loop latch:
    \begin{itemize}
        \item Always branch to next block in the list
    \end{itemize}
    \item Loop latch $L$:
    \begin{itemize}
        \item How many active instances in the loop?
        \item Any instance: branch to header $H$
        \item No instance: branch to next block
    \end{itemize}
\end{itemize}
...
\center{\includegraphics[scale=0.50]{images/loop-linearization3.pdf}}
