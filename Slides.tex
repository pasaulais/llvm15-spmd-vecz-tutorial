...
\newcommand{\penguin}[0]{\includegraphics[width = 1em]{penguin.png}}
...
\begin{itemize}
    \item Q\&A
    \item ...
    \item Happy vectorization! \hspace{1em} < \penguin, \penguin, \penguin, \penguin, \penguin, \penguin, \penguin, \penguin \hspace{0.1em} >
\end{itemize}
