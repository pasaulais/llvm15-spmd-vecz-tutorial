...
\begin{codebox}
define void @add_uniform(i32 addrspace(1)* %dst, i32 addrspace(1)* %src,
                         i32 %alpha) #0 {
entry:
  %tid = call spir_func i32 @_Z13get_global_idj(i32 0) #2
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %src, i32 %tid
  %0 = load i32, i32 addrspace(1)* %arrayidx, align 4
  %add = add nsw i32 %alpha, 1
  %add1 = add nsw i32 %add, %0
  %arrayidx2 = getelementptr inbounds i32, i32 addrspace(1)* %dst, i32 %tid
