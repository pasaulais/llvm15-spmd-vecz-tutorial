...
entry:
  ...
  \uniform[%add] = add nsw i32 \uniform[%alpha], \uniform[1]
  \uniform[%broadcasti] = insertelement <4 x i32> undef, i32 \uniform[%add], i32 0
  \uniform[%broadcast] = shufflevector <4 x i32> \uniform[%broadcast], <4 x i32> \uniform[undef],
      <4 x i32> \uniform[zeroinitializer]

  \varying[%add11] = add nsw <4 x i32> \uniform[%broadcast], \varying[%1]

  \varying[%arrayidx2] = getelementptr inbounds i32 addrspace(1)* \uniform[%dst], i32 \varying[%tid]
  \varying[%2] = bitcast i32 addrspace(1)* \varying[%arrayidx2] to <4 x i32> addrspace(1)*
  store <4 x i32> \varying[%add11], <4 x i32> addrspace(1)* \varying[%2], align 4
  ret void
}
\end{codebox}
